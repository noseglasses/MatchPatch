...
class HelpDialog(QDialog):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        help_text.setHtml(
            ...
            "<li>Choose an <b>Output file</b>, start normalization, and follow the import "
            "dialog for the generated measurement file.</li>"
            "<li>Press <b>Export</b> when measurement finishes to write the normalized "
            "setlist or preset.</li>"
            "</ol>"
            "<h3>Progress</h3>"
