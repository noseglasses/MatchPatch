...
def install_config_export_dialog_fakes(monkeypatch, selected_path):
    ConfigExportFileDialog.dialogs = []
    ConfigExportFileDialog.selected_path = selected_path
