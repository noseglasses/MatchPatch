...
For real results, use hardware mode. For learning the app without connecting a
processor, use loopback. For testing a more complete fake workflow without
hardware, use simulated mode.

## Which Backend Should I Choose?

| If you want to... | Choose |
|---|---|
| Balance real Helix or Pod Go presets | Hardware |
...
MatchPatch plays the reference DI from the computer into the processor, switches
...
> Warning:
> Loopback mode does not measure your processor tone. Do not use loopback results as
> final preset levels.
...
> Warning:
> Simulated mode is not a substitute for listening to the real processor.
...
- Measure the real processor: [Hardware Measurement](../workflows/hardware-measurement.md)
